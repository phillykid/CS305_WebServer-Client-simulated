...
//Run with java Client false 1.1 in terminal or
//java Client true 1.1 animals.clht
...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        {
         new Client(args[0],args[1],args[2]); //Experiment mode constructor 
        } else{
            new Client(args[0],args[1]); //Interactive mode constructor
        }
    ...
    public Client(String mode, String protocol){
    ...
    public Client(String mode, String protocol, String website){
        set_http_protocol(protocol);
        MODE = Boolean.parseBoolean(mode);
